...
public final class XposedBridge {
    ...
    public static final String TAG = "Penguin-Xposed";
    ...
    private static final CopyOnWriteSortedSet<Object> sLoadedPackageCallbacks = new CopyOnWriteSortedSet<>();
     ...
     * @hide
     */
    public static void addLoadPackage(Object callback) {
    ...
    /**
     * returns all callback objects to be executed when an app ("Android package") is loaded.
     *
     * @hide
     */
    public static Object[] getLoadedCallbacks(){
        synchronized (sLoadedPackageCallbacks) {
            return sLoadedPackageCallbacks.getSnapshot();
        }
    }
