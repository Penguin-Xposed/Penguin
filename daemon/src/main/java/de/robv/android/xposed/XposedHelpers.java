...
public final class XposedHelpers {
    private static final String LOGTAG = "Penguin-XposedHelpers";
    ...
    public static void closeSilently(final dalvik.system.DexFile dexFile) {
        if (dexFile != null) {
            try {
                dexFile.close();
            } catch (final IOException ignored) {
     ...
     */
    /*package*/
    public static void closeSilently(final ZipFile zipFile) {
        if (zipFile != null) {
            try {
                zipFile.close();
            } catch (final IOException ignored) {
